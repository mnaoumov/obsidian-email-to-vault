...
- **Otherwise**, download `email-to-vault-demo-vault.zip` from the [plugin releases](https://github.com/mnaoumov/obsidian-email-to-vault/releases), unzip it, and in Obsidian choose `Manage vaults...` → `Open folder as vault` → select the `email-to-vault-demo-vault-<version>` folder it unzips into.
