...
5. Wait for the automatic check (see [[03 Email notes and commands]]), or run the fetch command yourself. New emails become notes in your vault.
...
- Prefer your own email account instead? See [[02 IMAP mode]].
- To change where notes are created and what they contain, see [[03 Email notes and commands]] and [[04 Settings]].
