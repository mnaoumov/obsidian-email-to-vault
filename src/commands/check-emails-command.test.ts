...
import { CheckEmailsCommand } from './check-emails-command.ts';
...
describe('CheckEmailsCommand', () => {
  it('should have correct command properties', () => {
    const command = new CheckEmailsCommand(createMockPlugin(), createMockEmailChecker());
  ...
  it('should call checkEmails on execute', async () => {
    ...
    const command = new CheckEmailsCommand(createMockPlugin(), checker);
